...
export class HomeboardingManager {
  ...
  private init(): void {
    ...
    if (this.isFirstVisit()) {
      // Utiliser requestIdleCallback pour afficher uniquement quand le navigateur est au repos
      // Cela garantit que le LCP et autres métriques sont déjà mesurés
...
if (typeof window !== "undefined") {
  ...
  /*
  // Attendre que la page soit complètement chargée (après LCP)
  // pour éviter de bloquer les performances Lighthouse
